$(document).ready(function () {
    ...
    var getTrackStyle = function (el) {
        ...
        for (var i = 0; i < prefs.length; i++) {
            ...
            style += '.range {background: linear-gradient(to right, #8B87C4 0%, #8B87C4 ' + val + '%, #fff ' + val + '%, #fff 100%)}';
            style += '.range input::-' + prefs[i] + '{background: linear-gradient(to right, #8B87C4 0%, #8B87C4 ' + val + '%, #b2b2b2 ' + val + '%, #b2b2b2 100%)}';
        }
